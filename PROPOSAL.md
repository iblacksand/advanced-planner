...
### April 15
- [x] Finish the alias support
- [x] Create a [readme](http://iblacksand.github.io/advanced-planner/Tutorial.html) for basic scripting
- [x] Open public testing for text based scripting
- [x] Clean up the GUI
- [x] Write 2 journal entry
